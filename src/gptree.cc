/*
 * This code is copied from https://github.com/TsinghuaDatabaseGroup/GTree
 * I wanted to directly import it as sub-repository in this project.
 * However, the original code is too badly-organized to be linked as a whole.
 */
#include<iostream>
#include<cstdio>
#include<cstdlib>
